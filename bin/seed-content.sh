...
<li class="service-card"><img class="service-card-image" src="/wp-content/themes/rduende/assets/images/icons/icon-senaletica.jpg" alt="Señalética: interior, exterior y corporativa"></li>
<li class="service-card"><img class="service-card-image" src="/wp-content/themes/rduende/assets/images/icons/icon-expositores-stands.jpg" alt="Expositores y stands: eventos, ferias y promociones"></li>
...
<li class="service-card"><img class="service-card-image" src="/wp-content/themes/rduende/assets/images/icons/icon-instalacion-profesional.jpg" alt="Instalación profesional: experiencia, calidad y garantía"></li>
</ul>' --porcelain)
